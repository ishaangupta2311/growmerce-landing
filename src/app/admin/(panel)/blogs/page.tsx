...
export default async function BlogsPage({ searchParams }: PageProps<"/admin/blogs">) {
                  ...
                  {items.map((post) => (
                    <tr key={post.id} className="hover:bg-zinc-50/60">
                      ...
                      <td className="max-w-[320px] px-3 py-3">
                        <Link href={`/admin/blogs/${post.id}/edit`} className="line-clamp-2 font-semibold text-zinc-900 hover:text-brand">
                          {post.title}
                        </Link>
              ...
              {items.map((post) => (
                <li key={post.id} className="flex gap-3 p-3">
                  ...
                  <div className="min-w-0 flex-1">
                    <Link href={`/admin/blogs/${post.id}/edit`} className="line-clamp-2 text-sm font-semibold text-zinc-900">
                      {post.title}
                    </Link>
