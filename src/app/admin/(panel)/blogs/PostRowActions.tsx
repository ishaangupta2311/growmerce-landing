...
export default function PostRowActions({
  ...
  return (
    <div className="flex items-center justify-end gap-0.5">
      <Link href={`/admin/blogs/${post.id}/edit`} className={buttonClass("ghost", "icon")} aria-label={`Edit “${post.title}”`} title="Edit">
        ...
        <button
          ...
          onClick={() =>
            run(async () => {
              ...
              if (result.ok) router.push(`/admin/blogs/${result.data.id}/edit`);
              return result;
            })
          }
        >
