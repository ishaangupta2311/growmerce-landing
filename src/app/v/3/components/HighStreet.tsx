...
function WindowCard({
  ...
  return (
    <div
      className={`${styles.sticker} flex h-full flex-col rounded-[22px] bg-white p-5 shadow-[0_16px_34px_-26px_rgba(96,44,14,0.9)] ring-1 ring-[#171717]/8 ${className ?? ""}`}
    >
      <span className="inline-flex w-fit items-center gap-1.5 rounded-full bg-[#ffe4d6] px-2.5 py-1 text-[11px] font-extrabold tracking-[0.1em] text-[#ff5a1f] uppercase">
        {label}
      </span>
      <h4
      ...
      <div className="mt-2.5 text-[14.5px] leading-relaxed text-[#4a4a4a]">
        {children}
      </div>
    </div>
  );
...
function GrowsearchShop() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`${styles.shopLight} relative overflow-hidden rounded-[34px] bg-[#ffffff] shadow-[0_30px_60px_-40px_rgba(96,44,14,0.8)] ring-1 ring-[#171717]/10`}
      >
        ...
        <div className="relative px-5 pt-14 pb-6 sm:px-8 sm:pt-16 sm:pb-8">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              ...
              <p className="mt-3 max-w-lg text-[15.5px] leading-relaxed text-[#4a4a4a]">
            ...
            <div className="relative shrink-0">
              <div
                className={`${cart > 0 ? styles.cartNudge : ""} flex size-[52px] items-center justify-center rounded-full border-2 border-[#171717] bg-white text-[#171717]`}
                key={`cart-${cart}`}
              >
          ...
          <div className="mt-7 grid gap-3.5 sm:grid-cols-2">
            ...
            >
              ...
              <p className="mt-1.5 rounded-2xl bg-[#ffe4d6] px-3.5 py-2.5 text-[14px] leading-snug font-medium text-[#171717]">
            ...
            >
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <span
                    key={q}
                    className="rounded-full bg-[#fff4ee] px-3 py-1.5 text-[13px] font-medium text-[#4a4a4a] ring-1 ring-[#171717]/8"
                  >
                    {q}
                  </span>
                ))}
            ...
            >
              <div className="flex items-center gap-3 rounded-2xl bg-[#fff4ee] p-2.5 ring-1 ring-[#171717]/8">
                <span
                  aria-hidden
                  className="grid size-11 shrink-0 place-items-center rounded-xl bg-[#ffd6c2] text-[#ff5a1f]"
                >
                  <Sparkle className="size-4" />
                </span>
                <span className="min-w-0 flex-1">
                  <span className="block truncate text-[13.5px] font-bold text-[#171717]">
                    Kratom Seltzer · Yuzu
                  </span>
                ...
                <button
                  ...
                  className={`${styles.springy} ${styles.display} ${focusRing} shrink-0 rounded-full bg-[#171717] px-3.5 py-2 text-[13px] font-bold text-white hover:bg-[#ff5a1f]`}
                >
                  Add
                </button>
              </div>
          ...
          <div className="mt-7 flex flex-wrap items-center gap-x-5 gap-y-3">
            <Link
              href="#"
              className={`${styles.springy} ${styles.display} ${focusRing} group inline-flex items-center gap-2.5 rounded-full bg-[#ff5a1f] px-7 py-3.5 text-[17px] font-bold text-white shadow-[0_14px_28px_-14px_rgba(255,90,31,0.95)] hover:bg-[#e04a10]`}
            >
              Explore Growsearch
              <ChunkyArrow className="size-[18px] transition-transform duration-300 ease-out group-hover:translate-x-1" />
            </Link>

            <span className="inline-flex items-center gap-2 rounded-full border border-dashed border-[#171717]/25 px-3.5 py-2 text-[13px] font-semibold text-[#8a8a8a]">
              <span
                aria-hidden
          ...
          <p className="mt-4 text-[13.5px] font-semibold text-[#8a8a8a]">
...
function ShutteredShop({
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-[30px] bg-[#f7e6db] shadow-[0_22px_46px_-34px_rgba(96,44,14,0.85)] ring-1 ring-[#171717]/10">
