    ...
    <section className="border-t border-brand/10 bg-white px-6 py-20 sm:py-28 lg:px-10 lg:py-32">
      <Reveal className="mx-auto max-w-[1160px]">
        <div className="max-w-[1030px]">
          <p className="mb-5 font-poppins text-sm font-bold tracking-[0.18em] text-brand uppercase">Growmerce search</p>
          ...
          <div className="mt-10 grid max-w-[1020px] gap-6 font-poppins text-[clamp(1.15rem,2vw,1.55rem)] leading-[1.45] text-body-mute lg:grid-cols-2 lg:gap-14">
