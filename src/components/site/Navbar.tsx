      ...
      {mobile ? (
        <div className="border-t border-brand/15 bg-cream px-5 pb-6 lg:hidden">
          ...
          <div className="mt-5 flex gap-3">
            <Link href={GROWSEARCH_DEMO} onClick={() => setMobile(false)} className="flex-1 rounded-[10px] bg-brand py-2.5 text-center font-poppins text-[15px] font-bold text-white">
              See demo
            </Link>
